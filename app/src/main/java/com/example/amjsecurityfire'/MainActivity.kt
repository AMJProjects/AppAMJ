...
import com.amjsecurityfire.amjsecurityfire.ui.theme.MenuPrincipalActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerButton.setOnClickListener {
            val intent = Intent(this, com.amjsecurityfire.amjsecurityfire.ui.theme.RegistroActivity::class.java)
            startActivity(intent)
        }
    }
