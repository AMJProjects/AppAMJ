...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val eyeIcon = findViewById<ImageView>(R.id.eyeIcon)  // Certifique-se de ter o ID correto no layout
        ...
        eyeIcon.setOnClickListener {
            if (isPasswordVisible) {
                ...
                eyeIcon.setImageResource(R.drawable.closed_eye_icon)  // Altere para ícone de olho fechado
            } else {
                // Se a senha estiver oculta, mostra a senha
                senhaEditText.inputType = InputType.TYPE_CLASS_TEXT
                eyeIcon.setImageResource(R.drawable.eye_icon)  // Altere para ícone de olho aberto
            }
